...
class MySymNavigator( Node ):
    ...
    def aplicar_velocidad(self, x, w, t):
        ...
        self.publisher.publish(Twist()) #PREGUNTAR OJO 33333333333333333333333333333333333333333333333333 
 
    def mover_robot_a_destino(self, x, y ,o): ## AGREGAR CALCULO DE TIEMPO NECESARIO 
        start_x = self.x
        start_y = self.y
        start_o = self.o
