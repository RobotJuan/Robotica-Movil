...
class PIDController(Node):
    def __init__(self):
        ...
        self.setpoint_sub = self.create_subscription(Float64, 'setpoint_lineal_pi', self.setpoint_cb, 1)
        self.state_sub = self.create_subscription(Float64, 'state_lineal', self.state_cb, 1)
        self.control_pub = self.create_publisher(Float64, 'control_effort_lineal_pi', 1)
